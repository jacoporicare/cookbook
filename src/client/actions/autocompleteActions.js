...
export const AUTOCOMPLETE_SIDE_DISHES_REQUEST = 'AUTOCOMPLETE_INGREDIENTS_REQUEST';
export const AUTOCOMPLETE_SIDE_DISHES_SUCCESS = 'AUTOCOMPLETE_INGREDIENTS_SUCCESS';
export const AUTOCOMPLETE_SIDE_DISHES_FAILURE = 'AUTOCOMPLETE_INGREDIENTS_FAILURE';
