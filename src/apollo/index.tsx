 ...
 */
export function initOnContext(ctx: any) {
  ...
  const apolloClient =
    ctx.apolloClient || initApolloClient(inAppContext ? ctx.ctx : ctx, ctx.apolloState);
 ...
 */
export const withApollo = ({ ssr = true } = {}) => (PageComponent: NextPage) => {
