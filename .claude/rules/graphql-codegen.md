...
2. **API**: Run `pnpm --filter api codegen` to regenerate resolver types
...
5. **Web**: Run `pnpm --filter web codegen` to regenerate hooks and types (fetches schema from local API)
