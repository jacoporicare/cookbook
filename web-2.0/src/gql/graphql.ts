...
export type RecipeDetailItemFragment = { __typename?: 'Recipe', id: string, slug: string, title: string, tags: Array<string>, directions?: string | null, imageUrl?: string | null, sideDish?: string | null, preparationTime?: number | null, lastModifiedDate: any, imageUrl?: string | null, imageThumbUrl?: string | null, user: { __typename?: 'User', displayName: string } } & { ' $fragmentName'?: 'RecipeDetailItemFragment' };
