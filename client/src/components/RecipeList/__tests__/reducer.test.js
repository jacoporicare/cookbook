...
describe('RecipeList reducer', () => {
  ...
  it('fetches recipe list and sort them by title', () => {
    ...
    const action = fetchRecipeListSuccess([{ _id: 1, title: 'z' }, { _id: 2, title: 'a' }]);
    const stateAfter = {
      isFetching: false,
  ...
  it('adds recipe to the list and re-sort', () => {
    ...
    const stateAfter = {
      recipes: [{ _id: 2, title: 'a' }, { _id: 3, title: 'm' }, { _id: 1, title: 'z' }],
    };
  ...
  it('updates recipe in the list and re-sort', () => {
    const stateBefore = {
      recipes: [{ _id: 2, title: 'a' }, { _id: 3, title: 'm' }, { _id: 1, title: 'n' }],
    };
    const action = saveRecipeSuccess({ _id: 3, title: 'o' });
    const stateAfter = {
      recipes: [{ _id: 2, title: 'a' }, { _id: 1, title: 'n' }, { _id: 3, title: 'o' }],
    };
