...
function PrivacyPolicyPage() {
  return (
    <Layout>
      ...
      <p>
        Jakub built the Žrádelník app as a Free app. This SERVICE is provided by Jakub at no cost
      ...
      <p>
        ...
        which are accessible at Žrádelník unless otherwise defined in this Privacy Policy.
      </p>
      <p>
...
export default hocs(PrivacyPolicyPage);
